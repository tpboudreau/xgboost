...
class GroupedSampling : public SamplingStrategy {
 ...
 private:
  EllpackPageImpl* page_;
  float subsample_;
  dh::caching_device_vector<bst_subsample_group_t> selected_groups_;
  dh::caching_device_vector<bool> selected_group_markers_;
  bst_subsample_group_t low_group_ = 0U;
  bst_subsample_group_t high_group_ = 0U;
};
